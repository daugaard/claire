...
To install scikit learn and its dependencies for python 3 run: pip3 install scipy sklearn numpy.
...
| Device | Random Forest Accuracy | Neural Network |
| ------ | - | - |
| Light 1 | 99.09% | 99.03% |
| Light 2 | 99.56% | 98.03% |
| AV Switch 1 | 95.86% | 94.3 |
